...
namespace Gestures
{
    ...
    {   // TODO make the classification async
        [Tooltip("Script that calls the individual actions mapped to gestures")]
        public GestureActionExecution actionExecuter;
        ...
        private void CallGestureAction(int gestureId)
        {
            if (disableActionExecution)
                return;
            actionExecuter.ExecuteAction(gestureId);
        }
